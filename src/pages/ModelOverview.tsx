              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Mô hình cây cho bài toán phân loại và hồi quy
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-3">
                    <div>
                      <strong>Mô tả:</strong>
                      <p className="text-sm text-gray-600">
                        Mô hình học máy có cấu trúc dạng cây, đưa ra quyết định dựa trên các quy tắc if-then-else từ các đặc trưng dữ liệu. Dễ hiểu và trực quan hóa.
                      </p>
                    </div>
                    <div>
                      <strong>Ứng dụng:</strong>
                      <p className="text-sm text-gray-600">
                        Phù hợp cho các bài toán cần giải thích được quyết định, lựa chọn đặc trưng và các tập dữ liệu nhỏ đến trung bình.
                      </p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Thuật toán học máy học có giám sát dựa trên nhiều cây quyết định
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-3">
                    <div>
                      <strong>Mô tả:</strong>
                      <p className="text-sm text-gray-600">
                        Là một thuật toán ensemble learning, kết hợp nhiều cây quyết định để cải thiện độ chính xác và giảm overfitting. Hoạt động tốt với cả dữ liệu liên tục và phân loại.
                      </p>
                    </div>
                    <div>
                      <strong>Ứng dụng:</strong>
                      <p className="text-sm text-gray-600">
                        Hiệu quả cho các bài toán phân loại và hồi quy phức tạp, xử lý tốt dữ liệu lớn và nhiều chiều, có khả năng ước lượng tầm quan trọng của đặc trưng.
                      </p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Gradient boosting tối ưu cho tốc độ và hiệu năng
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-3">
                    <div>
                      <strong>Mô tả:</strong>
                      <p className="text-sm text-gray-600">
                        Một triển khai của thuật toán gradient boosting, nổi tiếng về tốc độ xử lý cao và hiệu suất vượt trội. Bao gồm kỹ thuật điều chuẩn (regularization) để giảm overfitting.
                      </p>
                    </div>
                    <div>
                      <strong>Ứng dụng:</strong>
                      <p className="text-sm text-gray-600">
                        Thường được sử dụng trong các cuộc thi khoa học dữ liệu và các ứng dụng công nghiệp đòi hỏi độ chính xác cao, xử lý hiệu quả dữ liệu có cấu trúc hoặc dạng bảng.
                      </p>
                    </div>
                  </CardContent>
                </Card>
