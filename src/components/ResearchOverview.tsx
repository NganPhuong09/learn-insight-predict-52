  ...
  const features = [
    {
      ...
      description: "Đáp ứng nhu cầu đo lường và phân tích mức độ hài lòng trong bối cảnh giáo dục trực tuyến phát triển mạnh mẽ."
    },
    {
    ...
    },
    {
      ...
      title: "Tính mới",
      description: "Tập trung vào đặc thù của từng học viên, kết hợp nhiều yếu tố đầu vào cho mô hình dự đoán đa chiều."
    }
  ];
