            ...
            <div className="w-full max-w-5xl flex justify-between relative">
              ...
              <div className="relative z-10 opacity-0 animate-fade-in" style={{ animationDelay: '0.2s' }}>
                <div className="flex flex-col items-center">
                  ...
                  <h3 className="font-semibold text-lg text-gray-900">Thu thập dữ liệu</h3>
                </div>
              </div>
              ...
              <div className="relative z-10 opacity-0 animate-fade-in" style={{ animationDelay: '0.4s' }}>
                <div className="flex flex-col items-center">
                  ...
                  <h3 className="font-semibold text-lg text-gray-900">Phân tích dữ liệu</h3>
                </div>
              </div>
              ...
              <div className="relative z-10 opacity-0 animate-fade-in" style={{ animationDelay: '0.6s' }}>
                <div className="flex flex-col items-center">
                  ...
                  <h3 className="font-semibold text-lg text-gray-900">Đo lường chất lượng</h3>
                </div>
              </div>
              ...
              <div className="relative z-10 opacity-0 animate-fade-in" style={{ animationDelay: '0.8s' }}>
                <div className="flex flex-col items-center">
                  ...
                  <h3 className="font-semibold text-lg text-gray-900">Làm sạch dữ liệu</h3>
                </div>
              </div>
              ...
              <div className="relative z-10 opacity-0 animate-fade-in" style={{ animationDelay: '1.4s' }}>
                <div className="flex flex-col items-center">
                  ...
                  <h3 className="font-semibold text-lg text-gray-900">Mô hình BSI</h3>
                </div>
              </div>
            </div>
          </div>
